...
<div id="login-form-wrap">
    <h2>Login</h2>
    <form id="login-form" method="POST" method="{{route('patient.register')}}">
        @csrf
        <p>
            <input type="text" id="name" name="name" placeholder="Name" required><i class="validation"><span></span><span></span></i>
        </p>
        <p>
    ...
    <div id="create-account-wrap"></div><!--create-account-wrap-->
</div><!--login-form-wrap-->
<!-- partial -->
