...
<div id="login-form-wrap">
    <h2>Login</h2>
    <form id="login-form" method="POST" method="{{route('patient.login')}}">
        @csrf
        <p>
    ...
    <div id="create-account-wrap"> <a href="{{route('patient.register')}}"> create account</a></div><!--create-account-wrap-->
</div><!--login-form-wrap-->
<!-- partial -->
